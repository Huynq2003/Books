...
const initialState: BookState = {
  books: [
    ...
    { id: 6, image:'https://ebdbook.vn/upload/sgk/lop11/tinhoc11cd2.jpg?v=1.0.1', title: 'Tin Học 11 - Khoa Học Máy Tính - Bộ Cánh Diều', author: 'HỒ SĨ ĐÀM (Tổng Chủ biên) - NGUYỄN ĐÌNH HÓA (Chủ biên) - HOÀNG VÂN ĐÔNG - HỒ CẨM HÀ - LÊ MINH HOÀNG - PHẠM THỊ ANH LÊ - NGUYỄN THANH TÙNG.', price: 120, description: 'Tin Học 11 - Khoa Học Máy Tính - Bộ Cánh Diều' },
    // Thêm sách khác
  ]
};
