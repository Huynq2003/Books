...
const AddBookForm: React.FC<AddBookFormProps> = ({
  ...
  useEffect(() => {
    if (editingBook) {
      ...
      setGrade(editingBook.grade || ''); // Ensure grade is a string
      setCategory(editingBook.category || ''); // Ensure category is a string
    }
  }, [editingBook, form]);
  ...
  const handleFinish = (values: any) => {
    const book: Book = {
      ...
      grade,
      category, // Include category in the book object
    };
