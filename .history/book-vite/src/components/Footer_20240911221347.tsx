      ...
      <div className="container mx-auto px-4">
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24} sm={12} md={6}>
            ...
            <div className="flex space-x-2 mt-2">
              <img src="/path/to/certificate1.png" alt="Chứng nhận 1" className="w-12 h-12" />
              <img src="/path/to/certificate2.png" alt="Chứng nhận 2" className="w-12 h-12" />
            </div>
          </Col>
          <Col xs={24} sm={12} md={6}>
            <h3 className="font-bold mb-4">Phương thức thanh toán</h3>
            <ul className="flex flex-wrap space-x-2">
              <li><img src="/path/to/visa.png" alt="Visa" className="w-8 h-8" /></li>
              <li><img src="/path/to/mastercard.png" alt="MasterCard" className="w-8 h-8" /></li>
              <li><img src="/path/to/jcb.png" alt="JCB" className="w-8 h-8" /></li>
              <li><img src="/path/to/momo.png" alt="Momo" className="w-8 h-8" /></li>
            </ul>
        ...
        <Row gutter={[16, 16]} className="mt-8">
          <Col xs={24} md={12}>
            ...
            <div className="flex space-x-2 mt-2">
              <img src="/path/to/qrcode.png" alt="QR code" className="w-20 h-20" />
              <div className="flex flex-col space-y-2">
                <img src="/path/to/appstore.png" alt="App Store" className="w-32 h-10" />
                <img src="/path/to/playstore.png" alt="Google Play" className="w-32 h-10" />
              </div>
            </div>
          </Col>
        </Row>
