      ...
      <div className="container mx-auto px-4">
        <Row gutter={[16, 16]}>
          ...
          <Col xs={20} sm={12} md={6}>
            ...
            <ul className="flex flex-wrap w-[150px] space-x-2">
              ...
              <li><img src="https://banner2.cleanpng.com/20180802/ivj/6889aece1763bc80718acc2c513b868f.webp" alt="JCB" className="w-8 h-8" /></li>
              <li><img src="https://cdn.haitrieu.com/wp-content/uploads/2022/10/Logo-MoMo-Circle.png" alt="Momo" className="w-8 h-8" /></li>
              <li><img src="https://cdn.haitrieu.com/wp-content/uploads/2022/10/Logo-ZaloPay-Square.png" alt="Momo" className="w-8 h-8" /></li>
              <li><img src="https://lh3.googleusercontent.com/proxy/2j5Hms6QnSW35B6V_fYgxdijD4sbQqQTK77VwHQ3wYybakyuVrkmgMromoZL8mVfDdN1bPjpSLkVSi3JH3Usa7Avy6AXNIAKgLw" alt="Momo" className="w-8 h-8" /></li>
            </ul>
            <h3 className="font-bold mt-4">Kết nối với chúng tôi</h3>
            <div className="flex space-x-2 mt-2">
              <FaFacebook style={{ fontSize: '24px',color:'blue' }} />
              <FaYoutube style={{ fontSize: '24px', color: 'red' }} />
              <SiZalo style={{ fontSize: '24px', color: 'blue' }} />
            </div>
          </Col>
        </Row>
