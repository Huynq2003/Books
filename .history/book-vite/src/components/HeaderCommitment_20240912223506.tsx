...
const HeaderCommitment: React.FC = () => {
  return (
    <div className="bg-white w-full shadow-md py-4">
      <div className="container mx-auto mt-52 flex justify-around items-center">
        <div className="flex items-center">
          <h3 className="text-blue-500 mr-[100px] text-[18px] font-semibold">Cam kết</h3>
        </div>
        <div className="flex justify-between space-x-6">
          <div className="flex items-center space-x-2">
            <CheckCircleOutlined style={{ color: '#1890ff', fontSize: '24px' }} />
            <span>100% hàng thật</span>
            <span className='text-[#ebebf0] text-[25px] mt-[-5px]'>|</span>
          </div>
          <div className="flex items-center space-x-2">
