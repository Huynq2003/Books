...
const Checkout: React.FC = () => {
  ...
  const [isCheckout, setIsCheckout] = useState(false); // State để quản lý việc hiển thị form
  ...
  const handleCheckout = () => {
    if (selectedItems.length === 0) {
      ...
      setIsCheckout(true); // Hiển thị form thanh toán
    }
  };
  ...
  return (
    <div className="checkout-container">
      ...
      {/* Hiển thị form thông tin người mua sau khi nhấn "Mua hàng" */}
      {isCheckout && (
