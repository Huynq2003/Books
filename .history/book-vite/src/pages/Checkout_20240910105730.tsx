      ...
      {cartItems.length === 0 ? (
        ...
        <>
          <List
            ...
            renderItem={item => (
              <List.Item>
                <Card style={{ lineHeight: 3, display: 'flex', justifyContent: 'space-evenly', width:150 }}
                 cover={
                  ...
                  <div className='flex gap-[35px] items-center'>
                    ...
                    <p className='mr-36'>Giá: ${item.price}</p>
                    <p className='mr-36'>Số lượng: {item.quantity} </p>
                  </div>
                </Card>
              </List.Item>
            )}
