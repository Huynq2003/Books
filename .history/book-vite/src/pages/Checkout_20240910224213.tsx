  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      >
        ...
        <p className='flex gap-2'><strong>Phương thức thanh toán:</strong> <p className='capitalize'>{paymentMethod === 'bankTransfer' ? `Chuyển khoản ngân hàng (${selectedBank})` : 'Thanh toán khi nhận hàng'}</p></p>
        <div className="mt-4">
