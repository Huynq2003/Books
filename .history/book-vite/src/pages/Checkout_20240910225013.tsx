...
const Checkout: React.FC = () => {
  ...
  const handleConfirmOrder = () => {
    ...
    navigate('/order-confirmation', { state: { orderInfo: { userInfo, selectedItems, paymentMethod, selectedBank, formattedTotalAmount } } });
          ...
          {paymentMethod === 'bankTransfer' && (
            ...
            >
              <Select placeholder="Chọn ngân hàng" onChange={value => setSelectedBank(value)}>
                <Select.Option value="bank1">Ngân hàng 1</Select.Option>
                <Select.Option value="bank2">Ngân hàng 2</Select.Option>
        ...
        <div className="mt-4">
          ...
          {selectedItems.map(item => (
            <div key={item.id} className="flex items-center gap-4 mt-2">
              <img src={item.image} alt={item.title} className="w-24 h-24 pt-3 object-cover" />
              <div>
